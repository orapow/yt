function Y() {
    ...
    //MO._T_VECTOR_MAPimgURLs = [q[4] + q[3] + "-" + integerRandomBy(0, 7)];
    ...
    //if (typeof MO._T_SATELLITE_HYBRID_WGS84_imgURLs == q[273]) {
    //    MO._T_SATELLITE_HYBRID_WGS84_imgURLs = function () {
    //        return [q[4] + integerRandomBy(0, 7) + "tianditu.com/cia_c/wmts?" + "SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=cia&STYLE=default&TILEMATRIXSET=c&FORMAT=tiles&"];
    //    };
    //}
    //if (typeof MO._T_SATELLITE_Mercator_imgURLs == q[273]) {
    //    MO._T_SATELLITE_Mercator_imgURLs = function () {
    //        return [q[4] + integerRandomBy(0, 7) + "tianditu.cn/img_w/wmts?" + "ERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&"];
    //    };
    //}
    //if (typeof MO._T_SATELLITE_HYBRID_Mercator_imgURLs == q[273]) {
    //    MO._T_SATELLITE_HYBRID_Mercator_imgURLs = function () {
    //        return [q[4] + integerRandomBy(0, 7) + "tianditu.com/cia_w/wmts?" + "SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=cia&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&"];
    //    };
    //}
    //if (typeof MO._T_TERRAIN_WGS84_imgURLs == q[273]) {
    //    MO._T_TERRAIN_WGS84_imgURLs = function () {
    //        return [q[4] + integerRandomBy(0, 7) + "tianditu.com/ter_c/wmts?" + "SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=ter&STYLE=default&TILEMATRIXSET=c&FORMAT=tiles&"];
    //    };
    //}
    //if (typeof MO._T_TERRAIN_HYBRID_WGS84_imgURLs == q[273]) {
    //    MO._T_TERRAIN_HYBRID_WGS84_imgURLs = function () {
    //        return [q[4] + integerRandomBy(0, 7) + "tianditu.com/cta_c/wmts?" + "SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=cta&STYLE=default&TILEMATRIXSET=c&FORMAT=tiles&"];
    //    };
    //}
    //if (typeof MO._T_TERRAIN_Mercator_imgURLs == q[273]) {
    //    MO._T_TERRAIN_Mercator_imgURLs = function () {
    //        return [q[4] + integerRandomBy(0, 7) + "tianditu.com/ter_w/wmts?" + "SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=ter&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&"];
    //    };
    //}
    //if (typeof MO._T_TERRAIN_HYBRID_Mercator_imgURLs == q[273]) {
    //    MO._T_TERRAIN_HYBRID_Mercator_imgURLs = function () {
    //        return [q[4] + integerRandomBy(0, 7) + "tianditu.com/cta_w/wmts?" + "SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=cta&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&"];
    //    };
    //}
    //if (typeof MO._T_SATELLITE_Mercator_imgURL == q[273]) {
    //    MO._T_SATELLITE_Mercator_imgURL = function () {
    ...
    //    };
    //}
    //if (typeof MO._T_map_Mercator_imgURL_Poi == q[273]) {
    //    MO._T_map_Mercator_imgURL_Poi = function () {
    //        return [q[4] + q[2] + "-" + integerRandomBy(0, 7)];
    //    };
    //}
    //if (typeof MO._T_map_WGS84_imgURL == q[273]) {
    ...
    //    };
    //}
    //if (typeof MO._T_map_WGS84_imgURL_Poi == q[273]) {
    //    MO._T_map_WGS84_imgURL_Poi = function () {
    //        return [q[4] + q[0] + "-" + integerRandomBy(0, 7)];
    //    };
    //}
    //if (typeof MO._T_map_Mercator_imgURL == q[273]) {
    ...
    //    };
    //}
    //if (typeof MO._T_ajax_proxyTextUrl == q[273]) {
    //	MO._T_ajax_proxyTextUrl = q[266]
    //}
    //if (typeof MO._T_map_MercatorEnglish_imgURL_Poi == q[273]) {
    //    MO._T_map_MercatorEnglish_imgURL_Poi = function () {
    //        return [q[4] + q[2] + "-" + integerRandomBy(0, 7)];
    //    };
    //}
    //if (typeof MO._T_map_WGS84English_imgURL_Poi == q[273]) {
    //    MO._T_map_WGS84English_imgURL_Poi = function () {
    //        return [q[4] + q[0] + "-" + integerRandomBy(0, 7)];
    //    };
    //}
    ...
    function bq(xE) {
        ...
        //NE.setGetTileUrl(Mq);
        //NE._r = function () {
        //    return xE.xo == q[204] ? MO._T_map_Mercator_imgURL_Poi()[0] : MO._T_map_WGS84_imgURL_Poi()[0];
        //};
        //NE.mr = function () {
        //    return MO._T_map_staticFileType;
        //};
        ...
        //_E.setGetTileUrl(mq);
        //_E._r = function () {
        //    return xE.xo == q[204] ? MO._T_SATELLITE_HYBRID_Mercator_imgURLs()[0] : MO._T_SATELLITE_HYBRID_WGS84_imgURLs()[0];
        //};
        //_E.mr = function () {
        //    return MO._T_map_staticFileType;
        //};
        ...
        //mE.maxZoom = Nq._maxZoom ? Nq._maxZoom : xE.rP[xE.rP[Qo] - 1];
        //mE.zIndex = 101;
        //mE.errorImg = MO._T_map_errorImgURLTer;
        //var Qe = new TW(mE);
        //Qe.setGetTileUrl(QW);
        //Qe._r = function () {
        //    return xE.xo == q[204] ? MO._T_TERRAIN_Mercator_imgURLs()[0] : MO._T_TERRAIN_WGS84_imgURLs()[0];
        //};
        //Qe.mr = function () {
        //    return MO._T_map_staticFileType;
        //};
        ...
        //qe.setGetTileUrl(qW);
        //qe._r = function () {
        //    return Nq.map.xo == q[204] ? MO._T_TERRAIN_HYBRID_Mercator_imgURLs()[0] : MO._T_TERRAIN_HYBRID_WGS84_imgURLs()[0];
        //};
        //qe.mr = function () {
        //    return MO._T_map_staticFileType;
        //};
        ...
        //MO.YMAP_NORMAL_MAP_ENGLISH = new Nq([vE, bE], MO.YMAP_Language.maptype_vector);
        //MO.YMAP_NORMAL_MAP.id = q[154];
        //MO.YMAP_NORMAL_MAP.getTileSize = function () {
        //    return 256;
        //};
        ...
        //MO.YMAP_HYBRID_MAP = new Nq([nE, _E], MO.YMAP_Language.maptype_satelliteblend);
        //MO.YMAP_HYBRID_MAP.id = "YMAP_HYBRID_MAP";
        //MO.YMAP_HYBRID_MAP.getTileSize = function () {
        //    return 256;
        //};
        //MO.YMAP_TERRAIN_MAP = new Nq([Qe], MO.YMAP_Language.maptype_terrain);
        //MO.YMAP_TERRAIN_MAP.id = "YMAP_TERRAIN_MAP";
        //MO.YMAP_TERRAIN_MAP.getTileSize = function () {
        //    return 256;
        //};
        //MO.YMAP_TERRAIN_HYBRID_MAP = new Nq([Qe, qe], MO.YMAP_Language.maptype_terrainPoi);
        //MO.YMAP_TERRAIN_HYBRID_MAP.id = "YMAP_TERRAIN_HYBRID_MAP";
        //MO.YMAP_TERRAIN_HYBRID_MAP.getTileSize = function () {
        //    return 256;
        //};
        //MO.YMAP_CUSTOM_MAP = new Nq([we], q[284]);
        //MO.YMAP_CUSTOM_MAP.id = "YMAP_CUSTOM_MAP";
        //MO.YMAP_CUSTOM_MAP.getTileSize = function () {
        //    return 256;
        //};
    ...
    function Mq(xE, VE, cE) {
        if (!MO.Io) {
            return Nq.map.xo == q[204] ? MO._T_map_Mercator_imgURL()[0] + q[175] + xE + q[174] + VE + q[173] + cE : MO._T_map_WGS84_imgURL()[0] + q[175] + xE + q[174] + VE + q[173] + cE + ".html";
        }
    }
    //function nq(xE, VE, cE) {
    //    if (!MO.Io) {
    //        return Nq.map.xo == q[204] ? MO._T_map_MercatorEnglish_imgURL_Poi()[0] + q[175] + xE + q[174] + VE + q[173] + cE : MO._T_map_WGS84English_imgURL_Poi()[0] + q[175] + xE + q[174] + VE + q[173] + cE + ".html";
    //    }
    //}
    function _q(xE, VE, cE) {
        xE = Nq.map.toSpanXLegalTile(xE, cE);
        if (!MO.Io) {
            return Nq.map.xo == q[204] ? MO._T_SATELLITE_Mercator_imgURL()[0] + q[153] + xE + q[152] + VE + q[151] + cE : MO._T_SATELLITE_WGS84_imgURL()[0] + q[153] + xE + q[152] + VE + q[151] + cE + ".html";
        }
    }
    //function mq(xE, VE, cE) {
    //    if (!MO.Io) {
    //        return Nq.map.xo == q[204] ? MO._T_SATELLITE_HYBRID_Mercator_imgURL()[0] + q[153] + xE + q[152] + VE + q[151] + cE : MO._T_SATELLITE_HYBRID_WGS84_imgURLs()[0] + q[153] + xE + q[152] + VE + q[151] + cE + ".html";
    //    }
    //}
    //function QW(xE, VE, cE) {
    //    xE = Nq.map.toSpanXLegalTile(xE, cE);
    //    if (!MO.Io) {
    //        return Nq.map.xo == q[204] ? MO._T_TERRAIN_Mercator_imgURL()[0] + q[153] + xE + q[152] + VE + q[151] + cE : MO._T_TERRAIN_WGS84_imgURLs()[0] + q[153] + xE + q[152] + VE + q[151] + cE+".html";
    //    }
    //}
    //function qW(xE, VE, cE) {
    //    if (!MO.Io) {
    //        return Nq.map.xo == q[204] ? MO._T_TERRAIN_HYBRID_Mercator_imgURL()[0] + q[153] + xE + q[152] + VE + q[151] + cE : MO._T_TERRAIN_HYBRID_WGS84_imgURLs()[0] + q[153] + xE + q[152] + VE + q[151] + cE+".html";
    //    }
    //}
